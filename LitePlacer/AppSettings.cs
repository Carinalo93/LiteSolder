...
namespace LitePlacer
{
    ...
    {
        //A Axis Place & Dispense
        public bool m4place_radioButton = true;
        public bool m4dispense_radioButton = false;

        public double B_dispense_speed = 30;
        public double dispense_value = 0.005;
        public double dispense_retract = 0.2;
        public double dispense_NozPcbZero = 20.0;
        public double dispense_Offset = 0.1;
        public double switchingPointHeight = 4.2;
        public double dispenseNozOffsetX = 111.0;
        public double dispenseNozOffsetY = 33.5;

        public double ajm_place = 0;
        public double ajm_dispense = 0;
        public double avm_place = 0;
        public double avm_dispense = 0;
        public double m4_place = 0;
        public double m4_dispense = 0; 
        public double tr4_place = 0;
        public double tr4_dispense = 0; 

        public bool m4deg09_place_radioButton = true;
        public bool m4deg18_place_radioButton = false;
        public bool m4deg09_dispense_radioButton = true;
        public bool m4deg18_dispense_radioButton = false;
